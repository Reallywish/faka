...
require: 配置项: 1. token字段 2. 刷新通关次数executeTimes(默认为90), 每次需要1分钟
author: jia110
date: 2022-09-23
'''

# 配置项
token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..WHCsb_vHqmJMwOACNU7XWUM9Hb5_KJb7eXgzIe4kf1o'
executeTimes = 90
winCount = 0
...
def execute():
    ...
    for i in range(0, executeTimes):
        ...
        result = requests.post(reportUrl, headers=headers,
                               json={'rank_score': 1, 'rank_state': 1, 'rank_time': 15, 'rank_role': 1, 'skin': 1,
